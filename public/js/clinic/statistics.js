document.addEventListener('DOMContentLoaded', function () {
    ...
    const allAppointmentCanvas = document.getElementById('AllAppointmentServices');
        ...
        document.getElementById('showClinicsAppointments').addEventListener('click', function() {
        ...
        document.getElementById('showClinicsSuccessfulAppointments').addEventListener('click', function() {
    ...
    function monthlyIncome() {
      fetch('/clinic/clinic-monthlyincome')
    ...
    function dailyIncome() {
      fetch('/clinic/clinic-dailyincome')
          .then(response => response.json())
          .then(({datasets, labels}) => {
